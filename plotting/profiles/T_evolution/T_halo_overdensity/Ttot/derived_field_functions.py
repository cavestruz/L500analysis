...
def _normalized_total_temperature_profile(data, *args, **kwargs) :
    ...
    return dict({ 'aexp':data.aexp, 'Mtot':Mtot, 
                  'halo_ids':data.halo_ids, 'T_mw':T_mw,
...
add_derived_field('T_tot/T1600c',function=_normalized_total_temperature_profile,
                 combine_function=calculate_normalized_total_temperature_profile, 
                  delta='1600c',units=K2keV)

add_derived_field('T_tot/T500c',function=_normalized_total_temperature_profile,
                 combine_function=calculate_normalized_total_temperature_profile, 
                  delta='500c',units=K2keV)

add_derived_field('T_tot/T200c',function=_normalized_total_temperature_profile,
                 combine_function=calculate_normalized_total_temperature_profile, 
                  delta='200c',units=K2keV)

add_derived_field('T_tot/T1600m',function=_normalized_total_temperature_profile,
                 combine_function=calculate_normalized_total_temperature_profile, 
                  delta='1600m',units=K2keV)

add_derived_field('T_tot/T500m',function=_normalized_total_temperature_profile,
                 combine_function=calculate_normalized_total_temperature_profile, 
                  delta='500m',units=K2keV)

add_derived_field('T_tot/T200m',function=_normalized_total_temperature_profile,
                 combine_function=calculate_normalized_total_temperature_profile, 
