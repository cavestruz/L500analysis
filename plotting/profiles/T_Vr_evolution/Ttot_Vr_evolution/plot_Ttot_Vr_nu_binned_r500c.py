...
pa = PlotAxes(figname='Ttot_Vr2_ratio_500c_nu%01d'%nu_threshold_key,
...
for aexp in aexps :
    ...
    Ttot = calculate_profiles_mean_variance(prune_dict(d=cldata['Ttot_cm_per_s_2_r500c'],
                                                      k=nu_cut_hids))
    Vr2 = calculate_profiles_mean_variance(prune_dict(d=cldata['Vr2_cm_per_s_2_r500c'],
                                                      k=nu_cut_hids)) 
