...
pa = PlotAxes(figname='Tnt_Vr2_ratio_500c_nu%01d'%nu_threshold_key,
...
for aexp in aexps :
    ...
    Tnt = calculate_profiles_mean_variance(prune_dict(d=cldata['Tnt_cm_per_s_2_r500c'],
                                                      k=nu_cut_hids))
...
pa.axes[Tnt_Vr2_ratio].text(0.2,50.,nu_label)
