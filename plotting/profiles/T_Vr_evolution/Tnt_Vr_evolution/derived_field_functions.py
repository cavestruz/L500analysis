...
def _Tnt_cm_per_s_2(data, *args, **kwargs) :
...
def calculate_Tnt_cm_per_s_2(input_data) :
    d = input_data
    Tnt_cm_per_s_2 = {}
    for hid in d['halo_ids'] :
        Tnt_erg = keV2erg*calculate_T_nonthermal(sigr=d['sigr'][hid],vr=d['vr'][hid],
                                         sigt=d['sigt'][hid],vt=d['vt'][hid])
        Tnt_cm_per_s_2[hid] = make_profile(x=d['Rscaled'][hid],
                                           y=Tnt_erg/mu/mp)

    return Tnt_cm_per_s_2
...
add_derived_field('Tnt_cm_per_s_2_r200m',
                  function=_Tnt_cm_per_s_2,
                  combine_function=calculate_Tnt_cm_per_s_2,
                  R_delta_key='r200m',
...
add_derived_field('Tnt_cm_per_s_2_r500c',
                  function=_Tnt_cm_per_s_2,
                  combine_function=calculate_Tnt_cm_per_s_2,
                  R_delta_key='r500c',
