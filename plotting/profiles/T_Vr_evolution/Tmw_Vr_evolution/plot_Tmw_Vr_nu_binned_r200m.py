...
pa = PlotAxes(figname='Tmw_Vr2_ratio_200m_nu%01d'%nu_threshold_key,
...
for aexp in aexps :
    ...
    Tmw = calculate_profiles_mean_variance(prune_dict(d=cldata['Tmw_cm_per_s_2_r200m'],
                                                      k=nu_cut_hids))
    Vr2 = calculate_profiles_mean_variance(prune_dict(cldata['Vr2_cm_per_s_2_r200m'],
                                                      k=nu_cut_hids)) 
...
pa.axes[Tmw_Vr2_ratio].text(0.2,50.,nu_label)
