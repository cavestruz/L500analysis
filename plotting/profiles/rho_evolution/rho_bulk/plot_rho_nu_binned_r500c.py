...
profiles_list = ['r_mid', 'r_out', 'r_in',
                 'M_gas_bulk_bin',
                 'rhog_bulk/rho500c',
                 'R/R500c']
...
rhoratio=r"$\tilde{\rho}=\rho_{g,bulk}/\rho_{500c}$"
frhoz1=r"$\tilde{\rho}/\tilde{\rho}(z=1)$"

pa = PlotAxes(figname='rho_r500c_nu%01d'%nu_threshold_key,
...
for aexp in aexps :
    ...
    rho[aexp] = calculate_profiles_mean_variance(prune_dict(d=cldata['rhog_bulk/rho500c'],
                                                            k=nu_cut_hids))
